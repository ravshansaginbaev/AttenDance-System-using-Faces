...
Images are available in the `Project Snap/` folder.

> Note: repository-specific image links and promotion text were removed to avoid author attribution.
"# AttenDance-System-using-Faces" 
